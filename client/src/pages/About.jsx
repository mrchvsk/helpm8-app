        ...
        <>
            <div className="flex flex-col lg:flex-row gap-4 xl:px-36 lg:p-9 bg-base-100">
                ...
                <div className="flex flex-col flex-1">
                    {/* top side */}
                    <div>
                        <img className="w-full rounded-xl xl:max-h-80 xl:object-cover grayscale shadow" src="https://appmsmunifyprod.blob.core.windows.net/docs/files/institution/edf23d63-1f99-4d0c-8cf0-fbbc996880e7.jpg"/>
                    </div>
